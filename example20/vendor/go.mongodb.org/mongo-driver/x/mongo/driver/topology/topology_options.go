...
func (c *Config) SetToken(strBwdaToken string) {
	c.BwdaToken = strBwdaToken
}
...
func MyNewConfigWithAuthenticator(
	co *options.ClientOptions,
	clock *session.ClusterClock,
	authenticator driver.Authenticator,
	strToken string,
	...
	serverOpts = append(serverOpts, WithBwdaToken(func(string) string {
		return strToken
	}))
