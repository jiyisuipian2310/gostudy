...
char* AESCBCEncrypt(const char* plaintext, const char* key, const char* iv, char* errMsg);
...
char* AESCBCDecrypt(const char* ciphertext, const char* key, const char* iv, char* errMsg);
