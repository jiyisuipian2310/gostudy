...
// 导出函数: SM4加密
//export SM4Encrypt
func SM4Encrypt(plaintext *C.char, key *C.char, iv *C.char, errMsg *C.char, errMsgLen C.int) *C.char {
...
// 导出函数: SM4解密
//export SM4Decrypt
func SM4Decrypt(ciphertext *C.char, key *C.char, iv *C.char, errMsg *C.char, errMsgLen C.int) *C.char {
    if errMsg == nil || errMsgLen < 128 {
        return nil
    }
